...
export const collection: Device[] = [
  ...
  },
  {
    ...
    condition: "good",
    description:
      "The Braun HLD 6 is a hand-held hair dryer of characteristic formal economy. Its pistol-grip form — a white ABS body, a single speed switch, a slotted nozzle — distils the object to its mechanical logic. Designed by Dieter Rams and Hans Gugelot, it treats the dryer not as a domestic appliance to be styled, but as a tool to be resolved.",
    specs: [
